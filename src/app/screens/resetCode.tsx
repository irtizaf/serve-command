...
const Resetcode = () => {
    ...
    const {setStep,username, setUsername,verificationCode, setVerificationCode} = Valueone()
            ...
            >
                ...
                >
                  ...
                  <br/>
                   ...
                   <Text> If your phone number exists in ServeCommand, you will receive a text with your code to update your password.
                   </Text>
                    </Text>
